...
namespace NetCoreBBS.Infrastructure.Repositorys
{
    public class TopicRepository : Repository<Topic>,ITopicRepository
    {
        ...
        public override ISelect<Topic> List(Expression<Func<Topic, bool>> predicate)
        {
        ...
        {
            var topics = _dbContext.Topics.Include(r=>r.User).Include(r=>r.Node).Include(r=>r.LastReplyUser);
            if (predicate != null)
            {
